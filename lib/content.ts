...
/**
 * Контент лежит обычными JSON-файлами в content/. Их же правит админка
 * из admin/: она меняет ровно эти файлы и коммитит их в репозиторий, после
 * чего сайт пересобирается. Базы данных у сайта нет, единственный источник
 * правды — репозиторий.
 *
